...
RBF = os.path.join(ROOT, "projects", "output_files", "bbcmicro_pocket.rbf")
PKG = os.path.join(ROOT, "pkg", "pocket")
OUT = os.path.join(ROOT, "release", "pocket")
CORE_ID = "plasticbugs.bbcmicro"
...
# release contains everything needed to produce bbcmicro.rom.
for extra in ("bbcmicro.mra", "README.md", os.path.join("tools", "mra_build.py")):
